$(function() {
	...
	$("#btn_addStudent").click(function(){
		addTab("添加学生", basePath + "addStudent", null);
	});
	
	// 查看学生个人信息
	$("#btn_showStudent").click(function(){
		// 获取当前选中行信息
		...
		addTab("查看 - " + stuNum.substring(8, 12) + " - " + nameZh, basePath + "showStudent?stuId=" + stuId + "&companyId=" + companyId, "icon-search");
	});
	...
	$("#btn_editStudent").click(function(){
		...
		addTab("编辑 - " + stuNum.substring(8, 12) + " - " + nameZh, basePath + "editStudent?stuId=" + stuId + "&companyId=" + companyId, "icon-edit");
	});
