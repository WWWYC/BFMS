...
<link rel="stylesheet" type="text/css" href="${basePath }/static/css/family/findFamily.css?t=${random_uuid}">

<%@include file="/WEB-INF/shared/jsTag.jsp"%>
<script type="text/javascript" src="${basePath }/static/js/family/findFamily.js?t=${random_uuid}"></script>


</head>
<body>
	<div id="grid_tb" style="height:auto">
		<a id="btn_showFamily" href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-search',plain:true" >查看学生家庭成员</a>
		<a id="btn_editFamily" href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-edit',plain:true" >编辑学生家庭成员</a>
	</div>
	...
	<form id="data_form">
		<table id="data_table" class="table table-striped">
			...
			<tr>
				...
				<td>组合</td>
				<td>
					<select id="group_list" name="groupId" style="width: 199px;height: 30px;">
						<option></option>
					</select>
				</td>
				<td>企业</td>
